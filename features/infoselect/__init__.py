...
from features.infoselect.gmm import *
from features.infoselect.mi import *
...
class SelectVars:
    ...
    def fit(self, X, y, verbose=True, eps=0):
        ...
        if verbose:
            print(
                'Round = {:3d}   |   Î = {:5.2f}   |   Δ%Î = {:5.2f}   |   Features={}'.format(
                    0, self.mi_list[-1], 0, posic
                )
            )
        ...
        for r in rounds:  # "r" of rounds/repetitions
            ...
            if verbose:
                print(
                    'Round = {:3d}   |   Î = {:5.2f}   |   Δ%Î = {:5.2f}   |   Features={}'.format(
                        r + 1, MI_best, self.delta_list[-1], posic
                    )
                )
    ...
    def get_info(self):
        ...
        dic = {
            'rounds': range(0, len(self.mi_list)),
